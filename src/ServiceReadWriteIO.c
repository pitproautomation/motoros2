...
void Ros_ServiceReadWriteIO_Initialize()
{
    ...
    motoRos_ASSERT_EQ_INT_MESSAGE(ret, RCL_RET_OK, SUBCODE_FAIL_INIT_SERVICE_READ_SINGLE_IO, "Failed to init service (%d)", (int)ret);
    ...
    motoRos_ASSERT_EQ_INT_MESSAGE(ret, RCL_RET_OK, SUBCODE_FAIL_INIT_SERVICE_READ_GROUP_IO, "Failed to init service (%d)", (int)ret);
    ...
    motoRos_ASSERT_EQ_INT_MESSAGE(ret, RCL_RET_OK, SUBCODE_FAIL_INIT_SERVICE_WRITE_SINGLE_IO, "Failed to init service (%d)", (int)ret);
    ...
    motoRos_ASSERT_EQ_INT_MESSAGE(ret, RCL_RET_OK, SUBCODE_FAIL_INIT_SERVICE_WRITE_GROUP_IO, "Failed to init service (%d)", (int)ret);
    ...
    motoRos_ASSERT_EQ_INT_MESSAGE(ret, RCL_RET_OK, SUBCODE_FAIL_INIT_SERVICE_READ_M_REG, "Failed to init service (%d)", (int)ret);
    ...
    motoRos_ASSERT_EQ_INT_MESSAGE(ret, RCL_RET_OK, SUBCODE_FAIL_INIT_SERVICE_WRITE_M_REG, "Failed to init service (%d)", (int)ret);
