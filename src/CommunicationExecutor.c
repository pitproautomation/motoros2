...
void Ros_Communication_ConnectToAgent()
{
    ...
    motoRos_ASSERT_EQ_INT(ret, RCL_RET_OK, SUBCODE_FAIL_OPTIONS_INIT);
    ...
    motoRos_ASSERT_EQ_INT(ret, RCL_RET_OK, SUBCODE_FAIL_OPTIONS_INIT_DOMAIN_ID);
...
void Ros_Communication_Initialize()
{
    ...
    motoRos_ASSERT_EQ_INT(ret, RCL_RET_OK, SUBCODE_FAIL_SUPPORT_INIT);
    ...
    motoRos_ASSERT_EQ_INT(ret, RCL_RET_OK, SUBCODE_FAIL_NODE_INIT);
...
void Ros_Communication_StartExecutors(SEM_ID semCommunicationExecutorStatus)
{
    ...
    motoRos_ASSERT_EQ_INT_MESSAGE(rc, RCL_RET_OK, SUBCODE_FAIL_TIMER_INIT_PING, "Failed creating rclc timer (%d)", (int)rc);
    ...
    motoRos_ASSERT_EQ_INT_MESSAGE(rc, RCL_RET_OK, SUBCODE_FAIL_TIMER_INIT_ACTION_FB, "Failed creating rclc timer (%d)", (int)rc);
    ...
    motoRos_ASSERT_EQ_INT_MESSAGE(rc, RCL_RET_OK, SUBCODE_FAIL_TIMER_INIT_USERLAN_MONITOR,
    ...
    motoRos_ASSERT_EQ_INT_MESSAGE(rc, RCL_RET_OK, SUBCODE_FAIL_CREATE_MOTION_EXECUTOR, "Failed creating motion control executor (%d)", (int)rc);
    ...
    motoRos_ASSERT_EQ_INT_MESSAGE(rc, RCL_RET_OK, SUBCODE_FAIL_CREATE_IO_EXECUTOR, "Failed creating I/O control executor (%d)", (int)rc);
    ...
    motoRos_ASSERT_EQ_INT_MESSAGE(rc, RCL_RET_OK, SUBCODE_FAIL_TIMER_ADD_PING, "Failed adding timer (%d)", (int)rc);

    rc = rclc_executor_add_timer(&executor_motion_control, &timerPublishActionFeedback);
    motoRos_ASSERT_EQ_INT_MESSAGE(rc, RCL_RET_OK, SUBCODE_FAIL_TIMER_ADD_ACTION_FB, "Failed adding timer (%d)", (int)rc);
    ...
    motoRos_ASSERT_EQ_INT_MESSAGE(rc, RCL_RET_OK, SUBCODE_FAIL_TIMER_ADD_USERLAN_MONITOR,
    ...
    rc = rclc_executor_add_action_server(&executor_motion_control,
        ...
        &g_actionServerFollowJointTrajectory);
    motoRos_ASSERT_EQ_INT_MESSAGE(rc, RCL_RET_OK, SUBCODE_FAIL_ADD_FJT_SERVER, "Failed adding FJT server (%d)", (int)rc);
    ...
    motoRos_ASSERT_EQ_INT_MESSAGE(rc, RCL_RET_OK, SUBCODE_FAIL_ADD_SERVICE_STOP_TRAJ, "Failed adding service (%d)", (int)rc);
    ...
    motoRos_ASSERT_EQ_INT_MESSAGE(rc, RCL_RET_OK, SUBCODE_FAIL_ADD_SERVICE_RESET_ERROR, "Failed adding service (%d)", (int)rc);
    ...
    motoRos_ASSERT_EQ_INT_MESSAGE(rc, RCL_RET_OK, SUBCODE_FAIL_ADD_SERVICE_START_TRAJ_MODE, "Failed adding service (%d)", (int)rc);
    ...
    motoRos_ASSERT_EQ_INT_MESSAGE(rc, RCL_RET_OK, SUBCODE_FAIL_ADD_SERVICE_START_QUEUE_MODE, "Failed adding service (%d)", (int)rc);
    ...
    motoRos_ASSERT_EQ_INT_MESSAGE(rc, RCL_RET_OK, SUBCODE_FAIL_ADD_SERVICE_QUEUE_POINT, "Failed adding service (%d)", (int)rc);
    ...
    motoRos_ASSERT_EQ_INT_MESSAGE(rc, RCL_RET_OK, SUBCODE_FAIL_ADD_SERVICE_SELECT_MOTION_TOOL, "Failed adding service (%d)", (int)rc);
    ...
    motoRos_ASSERT_EQ_INT_MESSAGE(rc, RCL_RET_OK, SUBCODE_FAIL_ADD_SERVICE_READ_SINGLE_IO, "Failed adding service (%d)", (int)rc);
    ...
    motoRos_ASSERT_EQ_INT_MESSAGE(rc, RCL_RET_OK, SUBCODE_FAIL_ADD_SERVICE_READ_GROUP_IO, "Failed adding service (%d)", (int)rc);
    ...
    motoRos_ASSERT_EQ_INT_MESSAGE(rc, RCL_RET_OK, SUBCODE_FAIL_ADD_SERVICE_WRITE_SINGLE_IO, "Failed adding service (%d)", (int)rc);
    ...
    motoRos_ASSERT_EQ_INT_MESSAGE(rc, RCL_RET_OK, SUBCODE_FAIL_ADD_SERVICE_WRITE_GROUP_IO, "Failed adding service (%d)", (int)rc);
    ...
    motoRos_ASSERT_EQ_INT_MESSAGE(rc, RCL_RET_OK, SUBCODE_FAIL_ADD_SERVICE_READ_M_REG, "Failed adding service (%d)", (int)rc);
    ...
    motoRos_ASSERT_EQ_INT_MESSAGE(rc, RCL_RET_OK, SUBCODE_FAIL_ADD_SERVICE_WRITE_M_REG, "Failed adding service (%d)", (int)rc);
